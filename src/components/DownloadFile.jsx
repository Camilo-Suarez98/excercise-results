const DownloadFile = () => {
  return (
    <>
      ...
      <a
        className='flex justify-center items-center text-center text-2xl text-green-500 transition duration-500 hover:text-red-500 hover:font-bold'
        href="/exercise-result.xlsx"
        download="exercise-result.xlsx"
      >
